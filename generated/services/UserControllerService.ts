...
// import { LoginUserVO } from "../models/LoginUserVO";
//
// export class UserControllerService {
//   // 教师登录
//   static async teacherLoginUsingPost(
//     request: UserLoginRequest
//   ): Promise<BaseResponse<LoginUserVO>> {
//     const response = await fetch("http://localhost:8101/api/user/teacher/login", {
//       method: "POST",
//       headers: {
...
//
//   // 学生登录
//   static async studentLoginUsingPost(
//     request: UserLoginRequest
//   ): Promise<BaseResponse<LoginUserVO>> {
//     const response = await fetch("http://localhost:8101/api/user/student/login", {
//       method: "POST",
//       headers: {
//         "Content-Type": "application/json",
//       },
...
export class UserControllerService {
  ...
  static async teacherLoginUsingPost(
    ...
    const response = await fetch(
      "http://localhost:8101/api/user/teacher/login",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  static async studentLoginUsingPost(
    ...
    const response = await fetch(
      "http://localhost:8101/api/user/student/login",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  // 超级管理员登录
  static async administratorLoginUsingPost(
    request: UserLoginRequest
  ): Promise<BaseResponse<LoginUserVO>> {
    const response = await fetch(
      "http://localhost:8101/api/user/administrator/login", // 超级管理员登录接口
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
